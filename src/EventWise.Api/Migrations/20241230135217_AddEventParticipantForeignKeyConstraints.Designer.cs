...
namespace EventWise.Api.Migrations
{
    ...
    [Migration("20241230135217_AddEventParticipantForeignKeyConstraints")]
    partial class AddEventParticipantForeignKeyConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventWise.Api.Events.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EventWise.Api.Events.UserEvent", b =>
                {
            ...
            modelBuilder.Entity("EventWise.Api.Events.EventParticipant", b =>
                {
                    ...
                    b.HasOne("EventWise.Api.Events.User", "Participant")
                        .WithMany()
            ...
            modelBuilder.Entity("EventWise.Api.Events.UserEvent", b =>
                {
                    b.HasOne("EventWise.Api.Events.User", "Host")
                        .WithMany()
